...
return [
    ...
    'fullBaseUrl' => false,  // ✅ apne path ke hisaab se change karo
    'imageBaseUrl' => 'img/',
    'cssBaseUrl' => 'css/',
    'jsBaseUrl' => 'js/',
    'paths' => [
    ...
    'Datasources' => [
        ...
        'persistent' => false,
        'host' => 'localhost',
        'username' => 'root',        // ✅ apne local MySQL ka username
        'password' => '',            // ✅ agar tumne password set nahi kiya
        'database' => 'gym',         // ✅ tumhare import kiye gaye gym.sql ka naam
        'encoding' => 'utf8',
        'timezone' => 'UTC',
        'flags' => [],
        'cacheMetadata' => true,
